...
from app.models.models import Project, ProjectStatus, SourceType
...
async def clone_repo(
    ...
    if not url.startswith("https://github.com/"):
        raise HTTPException(status_code=400, detail="Only public GitHub URLs are supported (https://github.com/...)")
